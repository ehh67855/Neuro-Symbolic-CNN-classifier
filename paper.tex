...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/qualitative_decoding_examples.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/beam_width_accuracy.png}
...
\begin{table}[t]
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        $B=1$ & 34.0 & 33.0 & 0.0311 & 2.309 \\
        $B=3$ & 82.0 & 79.0 & 0.0524 & 1.370 \\
        $B=5$ & 130.0 & 125.0 & 0.0736 & 0.976 \\
        $B=10$ & 250.0 & 240.0 & 0.1316 & 0.545 \\
        $B=20$ & 470.0 & 450.0 & 0.2349 & 0.306 \\
        $B=50$ & 830.0 & 780.0 & 0.6348 & 0.113 \\
        $B=110$ & 1550.0 & 1440.0 & 1.2427 & 0.058 \\
        Exhaustive & 110.0 & 550.0 & 0.0718 & 1.000 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/efficiency_tradeoff.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/recoverability_analysis.png}
